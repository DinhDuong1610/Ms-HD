 	...
 	<div class="page-container" >
		...
		<div class="sidebar" style="background-color: #213351;color: #fff;font-size: 13px" >
			<div class="sidebar-content">
				...
				<!-- Main navigation -->
				<ul class="navigation">
						<li class="active"><a href="{{route('admin.dashadminn')}}"><span>Dashboard</span> <i class="icon-screen2"></i></a></li>
						...
						<li>
							<a href="{{route('admin.exam.index')}}"><span>Quản lý kỳ thi</span> <i class="fab fa-buromobelexperte"></i></a>
							<ul>
								<li>
									<a href="{{route('admin.exam.index')}}"><span style="padding-right: 80px">Danh sách kỳ thi</span> <i class="fas fa-list"></i> </a>
								</li>
						...
						<li>
							...
							<ul>
								<li>
									<a href="{{url('admin/grade')}}"><span style="padding-right: 80px">Danh sách khối</span> <i class="fas fa-file-invoice"></i>
									</a>
								</li>
								<li><a href="{{url('admin/grade/create')}}"><span style="padding-right: 50px">Thêm khối</span> <i class="fas fa-plus"></i> </a></li>
