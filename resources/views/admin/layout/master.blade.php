...
<body>
    ...
    <div class="navbar navbar-inverse" role="navigation" style="background-color: #213351;margin-top: -20px">
        <div class="navbar-header">
            <a class="navbar-brand" href="{{ asset('giaovien/dash/dashbroad_gv') }}" style="font-size: 18px"><img
                    src="../../imgs/quochuy.gif" alt="" width="50" height="50"
            ...
            <li class="dropdown">
                ...
                <div class="popup dropdown-menu dropdown-menu-right">
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <tr>
                                <td><span class="status status-success item-before"></span> <a
                                        href="#">Frontpage fixes</a></td>
                            ...
                            <tr>
                                <td><span class="status status-info item-before"></span> <a href="#">Responsive
                                        layout changes</a></td>
                                <td><span class="text-smaller text-semibold">Layout</span></td>
                                <td class="text-center"><span class="label label-info">52%</span></td>
                            </tr>
                            <tr>
                                <td><span class="status status-success item-before"></span> <a href="#">Add
                                        categories filter</a></td>
                                <td><span class="text-smaller text-semibold">Content</span></td>
                                <td class="text-center"><span class="label label-success">100%</span></td>
                            </tr>
                            <tr>
                                <td><span class="status status-success item-before"></span> <a href="#">Media
                                        grid padding issue</a></td>
                                <td><span class="text-smaller text-semibold">Bugs</span></td>
                                <td class="text-center"><span class="label label-success">100%</span></td>
                            </tr>
                        </tbody>
    ...
    <div class="page-container">
        ...
        <div class="sidebar" style="background-color: #213351;color: #fff;font-size: 13px">
            ...
            <ul class="navigation">
                ...
                <li class="active"><a href="{{ asset('dashbroad_gv') }}"><span>Dashboard</span> <i
                            class="icon-screen2"></i></a></li>

                <li>
                    <a href=""><span>Loại câu hỏi</span> <i class="fas fa-question"></i></a>
                    <ul>
                        <li>
                            <a href="{{ url('giaovien/loaicauhoi/dsloai') }}"><span style="padding-right: 80px">Danh
                                    sách loại</span> <i class="fas fa-list"></i> </a>
                        </li>
                        <li>
                            <a href="{{ url('giaovien/loaicauhoi/themloai') }}"><span
                                    style="padding-right: 120px">Thêm loại</span><i class="fas fa-plus"></i> </a>
                        </li>
                ...
                <li>
                    ...
                    <ul>
                        <li>
                            <a href="{{ url('giaovien/cauhoi/dscauhoi') }}"><span style="padding-right: 80px">Danh
                                    sách câu hỏi</span> <i class="fas fa-list"></i> </a>
                        </li>
                        <li>
                            <a href="{{ url('giaovien/cauhoi/themcauhoi') }}"><span style="padding-right: 120px">Thêm
                                    câu hỏi</span><i class="fas fa-plus"></i> </a>
                        </li>

                    </ul>
                </li>
                <li>
                    <a href="{{ url('giaovien/dethi/dsdethi') }}"><span>Quản lý đề thi</span> <i
                            class="fab fa-buromobelexperte"></i></a>
                    <ul>
                        <li>
                            <a href="{{ url('giaovien/dethi/dsdethi') }}"><span style="padding-right: 80px">Danh sách
                                    đề thi</span> <i class="fas fa-list"></i> </a>
                        </li>
                        <li><a href="{{ url('giaovien/dethi/themdethi') }}"><span style="padding-right: 50px">Thiết
                                    kế ma trận đề thi</span> <i class="fas fa-edit"></i> </a></li>
        ...
        <a href="loaicauhoi"><span>Quản lý loại câu hỏi</span>  <i class="fas fa-question-circle"></i></a>
                ...
                <li>
                    <a href="{{ url('giaovien/mucdo/dsmucdo') }}"><span>Quản lý mức độ câu hỏi</span><i
                            class="fas fa-file-signature"></i></a>

                </li>

                <li>
                    <a href="{{ url('giaovien/ketqua/dsketqua') }}"><span>Quản lý kết quả</span> <i
                            class="fas fa-file-invoice"></i></a>

                </li>

                <li><a href="{{ asset('giaovien/dash/dashbroad_gv') }}"><span>Biểu đồ</span> <i
            ...
            <ul class="breadcrumb-buttons collapse">
                ...
                <li class="language dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src=""
                            alt=""> <span>German</span> <b class="caret"></b></a>
                    <ul class="dropdown-menu dropdown-menu-right icons-right">
